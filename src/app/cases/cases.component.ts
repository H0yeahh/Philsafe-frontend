  ...
  onSubmit() {
    if (!this.createcaseForm.valid) {
      ...
      console.log('Form control errors:', {
        hq: this.createcaseForm.get('hq')?.errors,
        officerInChargeId: this.createcaseForm.get('officerInChargeId')?.errors,
        rank_id: this.createcaseForm.get('rank_id')?.errors,
        location_id: this.createcaseForm.get('location_id')?.errors,
        email: this.createcaseForm.get('email')?.errors,
        password: this.createcaseForm.get('password')?.errors,
        is_approved: this.createcaseForm.get('is_approved')?.errors,
    ...
    this.isLoading = true;
    const { rank_id, hq, location_id, officerInChargeId } = this.createcaseForm.value;
